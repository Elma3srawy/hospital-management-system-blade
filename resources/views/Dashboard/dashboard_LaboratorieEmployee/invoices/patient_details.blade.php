...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">صور التحاليل</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{$laboratorie['patient_name']}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            @foreach($laboratorie['paths'] as $path)

                <li class="col-sm-6 col-lg-4" data-responsive="{{Storage::url($path)}}" data-src="{{Storage::url($path)}}">
                    <a href="#">
                        <img width="50px" height="350px" class="img-responsive" src="{{Storage::url($path)}}" alt="NO Image">
                    </a>
                </li>
            @endforeach
        </ul>
