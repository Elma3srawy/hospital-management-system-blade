            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                        src="{{isset($image_path) && !empty($image_path) ? Storage::url($image_path):URL::asset('Dashboard/img/faces/6.jpg')}}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{isset($image_path) && !empty($image_path) ? Storage::url($image_path):URL::asset('Dashboard/img/faces/6.jpg')}}"
                                                                class=""></div>
                                                ...
                                                @elseif(auth('ray_employee')->check())
                                                    <form method="POST" action="{{ route('ray_employee.logout') }}">
                                                        @elseif(auth('laboratorie_employee')->check())
                                                            <form method="POST"
                                                                  action="{{ route('laboratorie_employee.logout') }}">
                                                                @else
                                                                    <form method="POST"
