<!-- Deleted insurance -->
<div class="modal fade" id="delete{{$patient_ray->ray_id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('doctor.ray.destroy') }}" method="post">
                    @method('DELETE')
                    @csrf
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" readonly value="{{ $patient_ray->ray_description }}">
                        </div>
                    </div>
