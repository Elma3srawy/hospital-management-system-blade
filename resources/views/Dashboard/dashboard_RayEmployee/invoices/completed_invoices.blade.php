                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a href="{{ route('ray-employee.invoice.patient', $invoice->id) }}">{{ $invoice->patient_name }}</a></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('ray-employee-invoice.edit' , $invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;اضافة تشخيص </a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
