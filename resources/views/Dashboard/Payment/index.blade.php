                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('payment-account.create')}}" class="btn btn-primary" role="button"
                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($payments as $payment)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a href="{{route('payment-account.edit',$payment->id)}}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                                       ...
                                                       <a href="{{route('admin.payment.account.print',$payment->id)}}" class="btn btn-primary btn-sm" target="_blank" title="طباعه سند صرف"><i class="fas fa-print"></i></a>
