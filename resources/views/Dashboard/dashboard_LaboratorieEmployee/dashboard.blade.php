                        ...
                        <div class="card card-table-two">
                            ...
                            <div class="table-responsive country-table">
                                <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                                    ...
                                    <tbody>
                                    @forelse($latestFiveInvoices as $invoice )
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td class="tx-right tx-medium tx-inverse">{{$invoice->created_at}}</td>
                                            <td class="tx-right tx-medium tx-danger">{{$invoice->patient_name}}</td>
                                            <td class="tx-right tx-medium tx-inverse">{{$invoice->doctor_name}}</td>
