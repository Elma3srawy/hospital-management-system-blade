			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ route('patient.invoices') }}">قائمة الفواتير</a></li>
                            <li><a class="slide-item" href="{{ route('patient.laboratories') }}">المختبر</a></li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="#">قائمة الاطباء</a></li>
